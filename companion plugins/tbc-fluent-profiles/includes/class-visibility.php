...
class Visibility {
    ...
    public static function get_level_labels() {
        return [
            self::LEVEL_PUBLIC  => __('Public', 'tbc-fluent-profiles'),
            self::LEVEL_MEMBERS => __('Members Only', 'tbc-fluent-profiles'),
            self::LEVEL_FRIENDS => __('Friends Only', 'tbc-fluent-profiles'),
            self::LEVEL_ADMINS  => __('Admins Only', 'tbc-fluent-profiles'),
        ];
    }
}
