 ...
 * Description: Event calendar system for Two Birds Church - sorts WooCommerce products by event date and displays them in a calendar view.
 * Version: 5.1.0
 * Author: Darien Fawkes (updated by Claude)
