 ...
 *
 * Endpoints:
 *   POST /tbc-fp/v1/otp/verify  - Verify OTP code for any session
 *   POST /tbc-fp/v1/otp/resend  - Resend OTP SMS for any session
 *   POST /tbc-fp/v1/otp/voice   - Request voice call for any session
 *
...
class OtpApi {
    ...
    public function register_routes() {
        register_rest_route(TBC_FP_REST_NAMESPACE, '/otp/verify', [
            'methods'             => 'POST',
            'callback'            => [$this, 'handle_verify'],
            'permission_callback' => '__return_true',
        ]);

        register_rest_route(TBC_FP_REST_NAMESPACE, '/otp/resend', [
            'methods'             => 'POST',
            'callback'            => [$this, 'handle_resend'],
            'permission_callback' => '__return_true',
        ]);

        register_rest_route(TBC_FP_REST_NAMESPACE, '/otp/voice', [
            'methods'             => 'POST',
