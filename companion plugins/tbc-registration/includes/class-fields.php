 ...
 *
 * Field definitions are stored in wp_options key 'tbc_reg_fields'.
 * Field values are stored in wp_usermeta with prefix '_tbc_reg_{field_key}'.
 *
...
class Fields {
    ...
    const OPTION_KEY = 'tbc_reg_fields';
    ...
    public static function meta_key($field_key) {
        return TBC_REG_META_PREFIX . $field_key;
    }
