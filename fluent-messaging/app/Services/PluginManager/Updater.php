...
namespace FluentMessaging\App\Services\PluginManager;
...
class Updater
{
    ...
    function plugins_api_filter($_data, $_action = '', $_args = null)
    {
        ...
        if(!in_array($_args->slug, [$this->slug, 'fluent-messaging'])) {
            return $_data;
        }
    ...
    private function maybe_delete_transients()
    {
        ...
        if(isset($_GET['fluent-messaging-check-update'])) {
            if ( current_user_can( 'update_plugins' ) ) {
                $this->delete_transients();
                ...
                wp_redirect(admin_url('plugins.php?s=fluent-messaging&plugin_status=all'));
                exit();
            }
        }
    }
