// =============================================================================
// COMMENT BREAKDOWN SLOT - Reaction breakdown summary for CommentItem
// =============================================================================
...
export function CommentBreakdownSlot({
  objectId,
  reactionsCount,
  reactionBreakdown,
}: ReactionSlotProps) {
  ...
  return (
    <Pressable
      ...
      onPress={() => multiReactions?.openReactionBreakdown({ objectType: 'comment', objectId })}
    >
      <View style={styles.emojiStack}>
        {reactionBreakdown.slice(0, display.count).map((bd, i) => (
          <View
            key={bd.type}
