 ...
 *   - Profile update (intercepts FC REST /profile save + tbc_reg_save_fields AJAX)
 *
 * Registration uses its own JS (registration.js) and does NOT use this handler.
 *
 * Uses unified REST OTP endpoints:
 *   POST /tbc-reg/v1/otp/verify
 *   POST /tbc-reg/v1/otp/resend
 *   POST /tbc-reg/v1/otp/voice
 *
...
(function () {
    ...
    function installXHRInterceptor() {
        ...
        OrigXHR.prototype.send = function (body) {
            ...
            if (isAdminAjax) {
                ...
                isAjaxProfileSave = bodyStr.indexOf('tbc_reg_save_fields') !== -1;
            }
            ...
            if (pendingSessionKey) {
                xhr.setRequestHeader('X-TBC-REG-Session', pendingSessionKey);
    ...
    function resubmitProfileSave() {
        ...
        xhr.setRequestHeader('X-TBC-REG-Session', currentSessionKey);
