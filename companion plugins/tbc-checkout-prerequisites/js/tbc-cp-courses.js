(function($) {
    ...
    const TBC_CP_Courses = {
        ...
        handleContentClick(e) {
            ...
            const courseId = $el.closest('.tbc-cp-course-content').data('course-id');
        ...
        handleMarkComplete(e) {
            ...
            this.ajax('mark_complete', {
                ...
                $btn.prop('disabled', false)
                    ...
                    .html('<span class="tbc-cp-btn-icon tbc-cp-icon-check"></span>Mark Complete');
        ...
        hideLoading() {
            $('.tbc-cp-body').removeClass('tbc-cp-loading');
        },
