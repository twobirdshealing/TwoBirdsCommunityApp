<?php
/**
 * Uninstall handler for TBC Registration.
...
if (!get_option('tbc_reg_delete_data_on_uninstall')) {
    return;
}
...
delete_option('tbc_reg_fields');

// Remove OTP / verification settings (current tbc_reg_ prefix)
$otp_keys = [
    'twilio_sid',
    'twilio_token',
    'verify_service_sid',
...
delete_option('tbc_reg_delete_data_on_uninstall');

// Remove user meta (field values + registration complete flag)
global $wpdb;

// Remove custom field values (all keys with _tbc_reg_ prefix)
