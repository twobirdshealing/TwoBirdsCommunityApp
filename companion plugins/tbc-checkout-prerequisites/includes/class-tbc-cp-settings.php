...
class TBC_CP_Settings {
    ...
    private function get_available_forms() {
        ...
        return array_map(function($form) {
            ...
            $fields = [];
            if ($full_form && !empty($full_form['fields'])) {
                $skip_types = TBC_CP_SKIP_FIELD_TYPES;
    ...
    private function sanitize_step_data($step) {
        ...
        if ($type === 'course') {
            ...
            $sanitized['consult_notes_field_id'] = absint($step['consult_notes_field_id'] ?? 0) ?: null;
            ...
            <div class="tbc-cp-step-content">
                ...
                <div class="tbc-cp-step-meta">
                    ...
                    <?php else : ?>
                        ...
                        <?php endif; ?>
                        <?php if (!empty($step['consult_notes_field_id'])) : ?>
                            <span class="tbc-cp-meta-notes"><?php esc_html_e('Consult Notes', 'tbc-checkout-prerequisites'); ?></span>
                        <?php endif; ?>
                ...
                <div class="tbc-cp-modal__body">
                    <form id="tbc-cp-step-form">
                        ...
                        <div class="tbc-cp-field tbc-cp-form-options">
                            <label for="tbc-cp-consult-notes-field"><?php esc_html_e('Consultation Notes Field', 'tbc-checkout-prerequisites'); ?></label>
                            <select name="consult_notes_field_id" id="tbc-cp-consult-notes-field">
                                <option value=""><?php esc_html_e('None (no consultation notes)', 'tbc-checkout-prerequisites'); ?></option>
                            </select>
                            <p class="description"><?php esc_html_e('Select which form field stores admin consultation notes. This field is hidden from users and used in approval messages.', 'tbc-checkout-prerequisites'); ?></p>
                        </div>
                        ...
                        <div class="tbc-cp-field tbc-cp-form-options">
                            ...
                            <p class="description"><?php esc_html_e('Gate this step until the entry reaches a qualifying approval status.', 'tbc-checkout-prerequisites'); ?></p>
