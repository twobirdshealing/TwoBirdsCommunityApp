...
<head>
    ...
    <title><?php esc_html_e('Phone Verification', 'tbc-fluent-profiles'); ?></title>
    <?php wp_head(); ?>
    <link rel="stylesheet" href="<?php echo esc_url(TBC_FP_URL . 'assets/css/otp-modal.css?ver=' . TBC_FP_VERSION); ?>" />
</head>
    ...
    <div class="tbc-otp-modal" role="dialog" aria-modal="true" aria-labelledby="tbc-otp-title">
        ...
        <div class="tbc-otp-modal__header">
            <h2 class="tbc-otp-modal__title" id="tbc-otp-title">
                <?php esc_html_e('Phone Verification', 'tbc-fluent-profiles'); ?>
            </h2>
        </div>
        ...
        <div class="tbc-otp-modal__body">
            <p class="tbc-otp-modal__instructions" id="tbc-otp-instructions">
                <?php echo esc_html(
                    sprintf(
                        ...
                        __('Enter the 6-digit code sent to %s', 'tbc-fluent-profiles'),
            ...
            <div class="tbc-otp-modal__links">
                ...
                <a href="#" class="tbc-otp-modal__link tbc-otp-modal__link--voice" id="tbc-otp-voice" style="<?php echo ($is_fullpage && !$voice_enabled) ? 'display:none;' : ''; ?>">
                    <?php esc_html_e('Try voice call', 'tbc-fluent-profiles'); ?>
                </a>
                <?php endif; ?>
            </div>
        </div>
...
<script src="<?php echo esc_url(TBC_FP_URL . 'assets/js/otp-handler.js?ver=' . TBC_FP_VERSION); ?>"></script>
<?php wp_footer(); ?>
</body>
</html>
<?php endif; ?>
