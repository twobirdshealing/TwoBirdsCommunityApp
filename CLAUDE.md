...
we DONT want to break things! first understand the issue check the ACTUAL files from project our git is synced to lastest version do not recreate or change things that dont need chaning or unrelated to these fixes ect minimal code need for CORRECT fixes NOT hacks 

no i require the full files just ONLY make minimal changes to exsiting code but give me the complete file do not break code or change things other than was was requested.
